...
export const loadProperties = async (pageNumber,token) => {
	...
	const guestySearch='https://api.villatracker.ch/services/guesty/openapi/listings?';
	const shubSearch='https://api.villatracker.ch/local/listings?';
...
export const loadFavorites = async (favorites,token) => {
	...
	const guestySearch='https://api.villatracker.ch/services/guesty/openapi/listings?ids=';
	const shubSearch='https://api.villatracker.ch/local/listings?ids=';
