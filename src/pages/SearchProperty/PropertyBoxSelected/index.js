...
const PropertyBox = (props,token) => {
	...
	const showProperty = () => {
		history.push(PATH_PROPERTY, { property });
	};
		...
		<div className="property-box-wrapper col-xl-4 col-md-6">
			...
			<div className="property-box-footer">
				<div className="property-box-footer-left">
					...
					<div className="property-box-footer-left-icon-small"><img src={property?.tags?.indexOf("familyCollection")>-1?familyIcon:''} alt="" /></div>
					<div className="property-box-footer-left-icon-small"><img src={property?.tags?.indexOf("petsCollection")>-1?petsIcon:''} alt="" /></div>
					<div className="property-box-footer-left-icon-small"><img src={property?.tags?.indexOf("eventsCollection")>-1?eventsIcon:''} alt="" /></div>
					<div className="property-box-footer-left-icon-small"><img src={property?.tags?.indexOf("sustainCollection")>-1?sustainIcon:''} alt="" /></div>
				</div>
