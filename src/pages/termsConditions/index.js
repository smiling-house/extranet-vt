            ...
            <div className="row" style={{margin: 'auto', width: '80%'}}>
                ...
                <div className="row" style={{margin: 'auto'}}>
                    ...
                    <div className="col-12" style={{margin: '10px 0'}}>
                        ...
                        <p style={{fontSize: '23px'}}>Should you wish to cancel your booking for whatever reason, this should also be made in writing. Each property sets its own cancellation terms (shown on the property page and in your booking confirmation), on top of which the following standard condition applies to all bookings:</p>
                        <ul style={{fontSize: '23px', color: '#707070;'}}>
                            <li>
                                Cancellations made <b>30 or more days</b> before check-in follow the property's own cancellation terms.
                            </li>
                            <li>
                                Cancellations made <b>less than 30 days</b> before check-in: a minimum of <b>50% of the accommodation total is non-refundable</b>. Where the property's own terms are more restrictive, those stricter terms apply instead.
                            </li>
                            <li>
                                Some properties are offered on a <b>fully non-refundable</b> basis; where this is the case it is clearly stated on the property page before you book, and no refund is available after booking.
                            </li>
                        </ul>
                        <p style={{fontSize: '23px'}}>The 30-day point is calculated from your check-in date, using the local time at the property. Refundable security deposits are returned in full; booking and service fees are non-refundable.</p>
