...
import { baseURL, ShubAuth } from "../../core";
...
*/
  ...
  useEffect(() => {
    ...
    if (!coldId) return;
    // Was a SECOND verbatim copy of the ShubAuth bearer from core/index.js —
    // byte-identical, verified. One credential in two files means rotating one
    // and silently leaving the other live, so it now reads the single source.
    const COLD_TOKEN = ShubAuth;
