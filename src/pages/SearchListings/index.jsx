...
const [searchPropertyKeyWord, setSearchPropertyKeyWord] = useState('');
...
const listingIdsToUpdateCleaned = listingIdsToUpdate.map(id => id.replace('_unmapped', ''));
        ...
        const updateListingsData = {'ids':listingIdsToUpdateCleaned, 'status':propStatus, decliningReason:reason_decline, statusUpdatedBy:agentData.firstName}
        ...
        if(listingIdsToUpdateCleaned.length > 0 && propStatus !== '') {
            ...
            if(ShubResponse.data.success === true) {
                ...
                setUpdateStatusProcess( updateStatusProcess + 1 ); //No effect inside useEffect. So added the below line to run the function to refresh page
                setListings([]);
                getAllListingsForSearchKeyword();
...
//By Jaison 2025-04-22 - END
    ...
    */
    ...
    if (searchPropertyKeyWord.length > 4) {
...
//     setRefresh(false)
 ...
 }, [refresh,isRefresh, filterPropertyStatus,updateStatusProcess, filterPropertyZipcode,filterRegionMappedUnmapped,searchPropertyKeyWord])
...
*/}                    
                ...
                <div className="listings-main">
                    <div className="listings-title"><h1>Search Listings</h1></div>
...
<div class="row">
    <div class="col-6">
        <h4>Search by Property ID/Title/Nickname</h4>
        <input required type="text" placeholder="Search by Property ID/Title/Nickname" class="form-control" onChange={ (e) => setSearchPropertyKeyWord(e.target.value) }  />
    </div>
</div>
